        ...
        <div className="projects-container">
          ...
          <div className="project">
            <picture className="project-image">
              ...
              />
              <img
                src="img/jpg/new-zealand-police-logo.jpg"
            ...
            <div className="project-text">
              ...
              <p>
                My role in this project was mainly creating the UI for the
                police to interact with the various program settings and
